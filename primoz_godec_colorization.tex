...
\begin{equation}
L(\hat{z}, z) = - v(z) \sum_q z{q} \log (\hat{z}_{q}) 
...
\hspace{0.5em} - brez globalne mreže & D+G & MSE \\
...
\begin{equation}
KL-divegenca(\hat{Y}, Y) = \frac{1}{hw} \sum_{h, w} \sum_c Y_{h, w, c} \log \frac{Y_{h, w, c}}{\hat{Y}_{h, w, c}}
\label{eq:kld}
\end{equation}
