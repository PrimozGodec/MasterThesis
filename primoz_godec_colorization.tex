...
Vsak nivo ima tudi svojo aktivacijsko funkcijo. V tem primeru smo pri vseh nivojih uporabili funkcijo ReLU, razen pri zadnjem polnopovezanem, kjer je aktivacijska funkcija Softmax. Glede na to, da gre za klasifikacijski problem bomo za cenilno funkcijo uporabili križno entropijo. Optimizator, ki smo ga uporabljali za učenje, pa je Adam \cite{DBLP:journals/corr/KingmaB14}. Primer implementacije te nevronske mrež v ogrodju Keras je predstavljen v poglavju \ref{ch:keras}.
...
V zgornjem primeru smo mrežo učili na fiksnem številu korakov, kar je razvidno iz 
