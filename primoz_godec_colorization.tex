...
\end{center}
\caption{Slika prikazuje dva para za človekov vizualni sistem enako oddaljenih barv. Barve so zapisane v barvnih prostorih RGB in CIE L*a*b*. L*a*b* je barvni prostor, kjer enaka številčna razdalja med barvami pomeni tudi enako razliko za človekov vizualni sistem \cite{Prangnell}.}
\label{im:color_dist}
\end{figure}
