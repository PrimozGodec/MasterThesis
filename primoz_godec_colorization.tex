...
Barvanja črno-belih fotografij so se lotevali že v devetnajstem stoletju, ko so to počeli ročno. V sedemdesetih letih prejšnjega stoletja so se pojavili prvi pristopi z računalnikom. Kasneje so se pristopi izboljševali in postali vedno bolj avtomatski.
