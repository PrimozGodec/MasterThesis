...
\begin{center}
\centering
\includegraphics[width=9cm]{images-methods-comparison-100}
\end{center}
\caption{Slika prikazuje različne slike iz testne množice, ki so bile obarvane z pristopi opisanimi v tem delu. Vsaka vrstica prikazuje drugo metodo, prva vrstica prikazuje originalno sliko. Ime metode je označena na robu vrstice. Prva dva stolpca prikazujeta slike, ki so bile obarvane najbolje glede na napako, tretji in četrti prikazujeta slike, ki so bile z nekaterimi metodami obarvane dobro z drugimi pa slabo. Zadnje dva stolpca vključujeta slike, ki so pri vseh metodah imele med največjimi napakami.}
\label{im:images-100-compare}
\end{figure}
