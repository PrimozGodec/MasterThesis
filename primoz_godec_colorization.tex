...
\lstinputlisting[caption={Implementacija konvolucijske nevronske mreže za prepoznavanje objekta na sliki v vmesniku Keras.}, label=imp:vgg_like_imp, language=Python]{vvg_like.py}
...
\lstinputlisting[caption={Arhitektura S+G  predstavljena z implementacijo v vmesniku Keras.}, label=imp:app_sg, language=Python]{SG_arh.py}

\section{Arhitektura D+G}
\label{ch:app_dg}

\lstinputlisting[caption={Arhitektura D+G predstavljena z implementacijo v vmesniku Keras.}, label=imp:app_dg, language=Python]{DG_arh.py}

\section{Arhitektura X-VGG}
\label{ch:app_xvgg}

\lstinputlisting[caption={Arhitektura X-VGG predstavljena z implementacijo v vmesniku Keras.}, label=imp:app_xvgg, language=Python]{X_VGG_arh.py}
